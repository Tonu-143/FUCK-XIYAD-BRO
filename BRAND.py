...
for xd in range(5000):
	...
	ugen.append(uaku2)
try:
	prox= requests.get('https://github.com/Tonu-143').text
...
logo=("""
 ...
 .########..##.....##.##.....##.##....##.########.
\033[91;1m--------------------------------------------------
\033[97;1m>>     Owner    : TONU-143
\033[97;1m>>   Facebook   : MEHEDI HASAN TONU
\033[97;1m>>     Version  : 1.0.1
\033[97;1m>>     TOOL     : RANDOM
\033[92;1m>>       Group  : BRAND
\033[91;1m--------------------------------------------------""")
def linex():
	print('\033[91;1m--------------------------------------------------')
loop = 0
...
def fia():    
			print(logo)
			print('\x1b[97;1m>>> BRAND  VERSION :\x1b[1;92m 1.1.1 ')
